...
INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/HttpSecure", HttpsDestroy);

INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/HttpSecure", HttpsCleanup);
...
INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/HttpSecure", PrintRequestHeader);

INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/HttpSecure", PrintRequestFooter);

INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/HttpSecure", PrintHeader);

INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/HttpSecure", PrintFooter);
...
INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/HttpSecure", IsSecure);
