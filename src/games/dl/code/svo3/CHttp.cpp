...
INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/CHttp", HttpsDestroy___dupe2);

INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/CHttp", HttpsCleanup___dupe2);

INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/CHttp", HttpsPrepareRequestForServerHello);

INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/CHttp", HttpSendRequest___dupe2);

INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/CHttp", HttpsDownload___dupe2);

INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/CHttp", PrintRequestHeader___dupe2);

INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/CHttp", PrintRequestFooter___dupe2);

INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/CHttp", PrintHeader___dupe2);

INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/CHttp", PrintFooter___dupe2);

INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/CHttp", HttpRecvOnEnter);
...
INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/CHttp", HttpSendOnUpdate);

INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/CHttp", SetStatePostRequest);
...
INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/CHttp", HttpIdleOnEnter);

INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/CHttp", HttpIdleOnUpdate);

INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/CHttp", IsSecure___dupe2);

INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/CHttp", HttpCleanup___dupe2);
...
INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/CHttp", GetHttpState);

INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/CHttp", States___dupe2);

INCLUDE_ASM("/ProjectRYNO/dl/code/asm/nonmatchings/svo3/CHttp", setSocketType);
